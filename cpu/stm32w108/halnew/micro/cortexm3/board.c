...
#if 0  
  /* Configure GPIO for XTAL 32kHz */
  if (boardDescription->flags & BOARD_HAS_LSE) {
    /* External Low Speed 32K Oscillator */
    halGpioConfig(PORTC_PIN(6), GPIOCFG_ANALOG);
    halGpioConfig(PORTC_PIN(7), GPIOCFG_ANALOG);
  }
#endif
}
