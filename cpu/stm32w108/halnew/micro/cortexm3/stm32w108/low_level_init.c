...
/* Important note: This function is critical for waking up from deep sleep and it should not use more that 2 stack position
   ...
   Perhaps this function should be rewritten in assembler to avoid stack usage all together when waking up from deep sleep.
*/
__interwork int __low_level_init(void)
{
#ifdef CORTEXM3_STM32W108xB
